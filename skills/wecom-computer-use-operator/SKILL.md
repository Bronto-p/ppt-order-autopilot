...
- 样稿发送时：`04_sample/sample_send_receipt.json`
- 统一结果契约 JSON
...
5. 保存 post-send screenshot，写入 sent-message ledger；sample 生成 `sample_send_receipt.json`，final/revision delivery 生成 `delivery_receipt.json`。
